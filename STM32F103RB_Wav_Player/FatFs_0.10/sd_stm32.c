...
void SPI_SD_Init( void )
{
	...
	// init SPI1
	RCC->APB1RSTR |= RCC_APB1RSTR_SPI1RST;
    delay_ms( 15 );
    RCC->APB1RSTR &= ~RCC_APB1RSTR_SPI1RST;
 
	SPI1->CR1 |= SPI_CR1_MSTR | SPI_CR1_SSM | SPI_CR1_SSI | SPI_CR1_CPHA | SPI_CR1_CPOL | SPI_CR1_BR_0;
...
//BYTE pdrv, BYTE*buff, DWORD sector, UINT count
